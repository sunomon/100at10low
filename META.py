        ...
        if start_time < now < end_time - datetime.timedelta(hours=1):
            ...
            if target7_price <= current_price < target7_price*1.02 and target7_price*1.1 <= predicted_close_price:
                ...
                if 5000 < krw < 1000000 and meta < 10000/(target7_price*1.02):
                    upbit.buy_market_order("KRW-META", krw*0.9995)
            if target8_price <= current_price < target8_price*1.02 and target8_price*1.125 <= predicted_close_price:
                if krw >= 1000000 and meta < 10000/(target8_price*1.02):
                    upbit.buy_market_order("KRW-META", 1000000)
                if 5000 < krw < 1000000 and meta < 10000/(target8_price*1.02):
                    upbit.buy_market_order("KRW-META", krw*0.9995)
            if target9_price <= current_price < target9_price*1.02 and target9_price*1.15 <= predicted_close_price:
                if krw >= 1000000 and meta < 10000/(target9_price*1.02):
                    upbit.buy_market_order("KRW-META", 1000000)
                if 5000 < krw < 1000000 and meta < 10000/(target9_price*1.02):
                    upbit.buy_market_order("KRW-META", krw*0.9995)
            if target10_price <= current_price < target10_price*1.02 and target10_price*1.2 <= predicted_close_price:
